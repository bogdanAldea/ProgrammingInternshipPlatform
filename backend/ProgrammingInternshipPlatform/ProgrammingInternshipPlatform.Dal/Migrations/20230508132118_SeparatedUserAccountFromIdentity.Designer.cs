...
namespace ProgrammingInternshipPlatform.Dal.Migrations
{
    ...
    [Migration("20230508132118_SeparatedUserAccountFromIdentity")]
    partial class SeparatedUserAccountFromIdentity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProgrammingInternshipPlatform.Domain.Account.Models.Intern", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("ProgrammingInternshipPlatform.Domain.Account.Models.Intern", b =>
                {
                    b.HasOne("ProgrammingInternshipPlatform.Domain.Account.Models.UserAccount", "Account")
                        .WithOne()
                        .HasForeignKey("ProgrammingInternshipPlatform.Domain.Account.Models.Intern", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProgrammingInternshipPlatform.Domain.Account.Models.Trainer", b =>
                {
                    b.HasOne("ProgrammingInternshipPlatform.Domain.Account.Models.UserAccount", "Account")
                        .WithOne()
                        .HasForeignKey("ProgrammingInternshipPlatform.Domain.Account.Models.Trainer", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProgrammingInternshipPlatform.Domain.InternshipManagement.Models.Internship", b =>
                {
                    b.HasOne("ProgrammingInternshipPlatform.Domain.Locations.Models.Location", null)
                        .WithOne()
                        .HasForeignKey("ProgrammingInternshipPlatform.Domain.InternshipManagement.Models.Internship", "LocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ProgrammingInternshipPlatform.Domain.InternshipManagement.Models.Mentorship", b =>
                {
                    b.HasOne("ProgrammingInternshipPlatform.Domain.InternshipManagement.Models.Internship", null)
            ...
            modelBuilder.Entity("ProgrammingInternshipPlatform.Domain.InternshipManagement.Models.Timeframe", b =>
                {
                    b.HasOne("ProgrammingInternshipPlatform.Domain.InternshipManagement.Models.Internship", null)
                        .WithOne("Timeframe")
                        .HasForeignKey("ProgrammingInternshipPlatform.Domain.InternshipManagement.Models.Timeframe", "InternshipId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ProgrammingInternshipPlatform.Domain.Locations.Models.Location", b =>
                {
                    b.HasOne("ProgrammingInternshipPlatform.Domain.Locations.Models.Company", null)
                        .WithMany("Locations")
